...
const part1 = [
  ...
  { week: 'Part 1 – Week 9', title: 'Bonus Unit — WhatsApp Preview + Live Q&A (5 Weekly Sessions with Experts)', attach: 2, time: '1h 25m', items: ['Bonus Lesson: Connecting WhatsApp with n8n — A Sneak Peek into Part 2', '5 Weekly Live Q&A Sessions with Experts — 1 session per week, attend any session at your convenience to get your business-specific doubts cleared', 'Community Access — Join our exclusive community of automation builders, share workflows, ask questions, and grow together'], icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg> },
