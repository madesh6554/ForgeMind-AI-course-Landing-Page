...
const part1 = [
  { week: 'Part 1 – Week 1', title: 'Unit 0: Course Introduction — What You\'ll Be Able to Build', attach: 1, time: '4m 26s', thumb: '/course-images/thumbs/Week1.webp', image: '/course-images/Week1.png', items: ['Welcome to the n8n Starter Course: What to Expect and How This Will Transform Your Business'], icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3"/></svg> },
  { week: 'Part 1 – Week 2', title: 'Unit 1: n8n Fundamentals — Setting Up Your Automation Engine', attach: 11, time: '57m 11s', thumb: '/course-images/thumbs/Week2.webp', image: '/course-images/Week2.png', items: ['What is n8n? How Businesses Use It to Eliminate Repetitive Work', 'Introduction to n8n and No-Code Automation', 'Key Concepts in Automation Every Business Owner Should Know', 'Installation guide for MacOS + Cloud hosting on Hostinger', 'Installation guide for Windows + Guide for non-cloud hosting', 'n8n Fundamentals: A Deep Dive into Trigger Nodes', 'n8n Self-Hosted AI Starter Kit - Local Docker Installation Guide', 'Common Setup Issues & Quick Fixes', 'The Heart of the Workflow: n8n Data Flow & Transformation', 'Node Reference Sheet — Your Go-To Cheat Sheet', 'Quiz 1'], icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg> },
  ...
  { week: 'Part 1 – Week 9', title: 'Bonus Unit — WhatsApp Preview + Live Q&A', attach: 2, time: '1h 25m', items: ['Bonus Lesson: Connecting WhatsApp with n8n — A Sneak Peek into Part 2', 'Q&A Session — Get Your Business-Specific Doubts Cleared'], icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg> },
