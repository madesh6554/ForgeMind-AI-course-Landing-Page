...
const faqs = [
  ...
  { q: 'What about the WhatsApp API — is it the real production API?', a: <>The course uses Meta test numbers for learning. Production API setup is not covered in the course, but registered businesses (GST/MSME) needing a production number can contact us at{' '}<a href="https://wa.me/919342245724?text=Hi!%20I%20want%20to%20know%20more%20about%20the%20WhatsApp%20Business%20API%20setup" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--wa)', fontWeight: 600, textDecoration: 'none' }}>+91 93422 45724</a>.</> },
