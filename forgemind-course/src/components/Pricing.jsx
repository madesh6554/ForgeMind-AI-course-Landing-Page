...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="rv" style={{ textAlign: 'center', position: 'relative', borderBottom: '1px solid var(--bdr)', padding: isMobile ? '52px 0' : '88px 0' }}>
      <div style={{
        position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)',
        width: 500, height: 500, background: 'radial-gradient(circle,var(--rg),transparent 70%)', pointerEvents: 'none'
      }}/>
      <div className="ctr">
        <div className="shc">
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, color: 'var(--t2)', marginBottom: 8 }}>One-time payment</div>
