...
const slides = [
  ...
  { thumb: '/course-images/preview-appointment-bot.png', full: '/course-images/preview-appointment-bot.png', cap: '08 — WhatsApp Appointment Bot — Automated Booking Workflow' },
  { thumb: '/course-images/preview-sales-agent.png',    full: '/course-images/preview-sales-agent.png',    cap: '09 — Sales Agent Automation — AI-Powered Sales Workflow' },
  { thumb: '/course-images/preview-bulk-whatsapp.png',  full: '/course-images/preview-bulk-whatsapp.png',  cap: '10 — Bulk WhatsApp Messaging — Send 1000+ Messages' },
]
